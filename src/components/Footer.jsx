				...
				<main className="col-12">
					<div className="row row-gap-5">
						...
						<article className="col-12 col-lg-6 text-center">
							...
							<p className="mt-3">
							"Welcome to Algohary your go-to destination for trendy, high-quality clothing for all occasions! We offer a wide range of stylish apparel that combines comfort, elegance, and affordability. Whether you're dressing up for a special event or refreshing your everyday wardrobe, Algohary has something for everyone. Step into style with us today!"
							</p>
						</article>
							...
							<ul className="d-flex flex-column align-items-center align-items-lg-start ps-0 gap-2">
								...
								<li>
									<a
										...
										href="mailto:jaykamde8080@gmail.com"
										title="get in touch"
									>
										aniketkamde.dev1@gmail.com
									</a>
								</li>
								<li>
									<a
										href="https://www.linkedin.com/in/aniket-kamde-111872267/"
										target="_blank"
